...
def create_registration(data: RegistrationInput) -> dict:
    ...
    Quota check happens before this function is called.

    Flow:
      1. Insert into 'registrations' table (seq auto-generated by DB)
      2. Read back the DB-generated seq, build reference like "HP-2026-00042"
      3. Insert each member into 'members' table
      4. If any member insert fails, delete the registration (CASCADE cleans up)
      5. Return data dict for QR code generation and email sending
    """
